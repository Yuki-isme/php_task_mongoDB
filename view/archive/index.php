<div class="col-12">
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title float-start">List Archive</h2>

            <div class="clearfix"></div>


            <div class="float-end" style="margin-left: 10px">
                <a href="/bill/index" class="btn btn-outline-success">
                    View Bill List
                </a>
            </div>
            ...
            <div class="d-flex justify-content-between" style="margin-top:10px">
                <div>
                    <input type="text" placeholder="Search" class="form-control rounded" id="search">
                </div>
            ...
            <div class="card-footer">
                <nav aria-label="Page navigation">
                    <ul class="pagination float-end" id="pagination">
                        <?php if (count($archives) > 0 && $page > 1) : ?>
                            <li class="page-item">
                        ...
                        <?php endfor; ?>
                        <?php if (count($archives) > 0 && $page < $totalPage) : ?>
                            <li class="page-item">
